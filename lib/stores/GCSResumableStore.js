...
class GCSResumableStore extends DataStore {
    ...
    create(req) {
        return new Promise((resolve, reject) => {
            ...
            if (upload_metadata.contentLength) {
                reqOpts.headers['X-Upload-Content-Length'] = upload_metadata.contentLength;
            }

            if (upload_metadata.contentType) {
                reqOpts.headers['X-Upload-Content-Type'] = upload_metadata.contentType;
            }
