        ...
        return new Promise((resolve, reject) => {
            ...
            splitter.on('chunkFinished', (filepath) => {
                ...
                const p = Promise.resolve()
                    // TODO: we don't have headers here to check the offset and upload-length
                    // to know whether this `isFinalRequest`. Find a different way to check
                    // the part size on the final request.
                    //
                    // .then(async() => {
