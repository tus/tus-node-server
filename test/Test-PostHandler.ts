...
describe('PostHandler', () => {
    let req: { headers: Record<string, string | number>, url?: string, host?: string } = { headers: {} };
    // @ts-expect-error
    let res: http.ServerResponse<http.IncomingMessage> = new http.ServerResponse({ method: 'POST' });
